...
#define STRING_CONFIG_H_AUTHOR "(NoKeRse, 3ndr3 SKR3M3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "3ndr3 3 SKR3M3"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43, -9, -0.74 }
